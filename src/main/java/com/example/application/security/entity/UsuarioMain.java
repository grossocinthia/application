...
package com.example.application.security.entity;
...
public class UsuarioMain implements UserDetails {
    ...
    public static UsuarioMain build(Usuario usuario){
        ...
        return new UsuarioMain(usuario.getNombre(), usuario.getNombreUsuario(), usuario.getEmail(), usuario.getPassword(), authorities);
    }
